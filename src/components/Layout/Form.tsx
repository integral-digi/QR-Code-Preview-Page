...
const Form = ({ children }: any) => {
  ...
  return (
    <div className="flex justify-center">
      <div className=" w-[341px] md:w-[624px] lg:w-[1352px] bg-[#FCFCFC]">
        {/* form head  */}
        <div className="flex justify-between items-center bg-[#EFFCF4] rounded-[4px] px-3.5 md:px-8 py-3.5 h-[77px]">
          ...
          <div className="flex space-x-4">
            <button className="text-[#FCFCFC] font-semibold text-lg justify-center bg-[#5BDB8A] rounded-[4px] flex items-center h-10 md:h-[48px] w-10 md:w-[176px]">
            ...
            <button className="  border-[2px] border-[#5BDB8A] rounded-[4px] flex items-center justify-center h-10 md:h-[48px] w-10 md:w-12">
              <div className="w-6 h-6">
                <img
        ...
        {/* form body  */}
        <div className="flex justify-between lg:items-center md:px-9 px-7 py-8 lg:flex-row flex-col-reverse items-start w-full">
          <div className="space-y-2">
            <h1 className="font-primary text-[#161A23] font-semibold text-base ">
              Shorten link
            </h1>
            <div className="relative lg:w-[620px] md:w-[580px] w-full">
              <input
                type="text"
                className="lg:w-[585px] border border-[#D9D9D9] rounded-[4px] outline-none block md:w-[535px] w-full h-[48px] text-[#5BDB8A] text-base font-primary font-normal px-6 "
